...
const Router = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'Cityagent/RegisterCityAgent', element: <FormCityAgentRegistration /> },  // /admin/Cityagent/RegisterCityAgent
      { path: 'Cityagent/CityAgentDocument', element: <FormCityAgentDocument /> },  // /admin/Cityagent/CityAgentDocument
